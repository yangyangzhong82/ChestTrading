...
void showShopItemBuyForm(Player& player, const ItemStack& item, BlockPos pos, int dimId, int slot, int unitPrice, BlockSource& region, const std::string& itemNbtStr);
