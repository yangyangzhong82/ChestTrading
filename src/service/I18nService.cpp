        ...
        nlohmann::json zh = {
            {"chest",
             {{"locked", "§c这个箱子已经被锁定了，你无法打开。"},
              ...
              {"type_recycle", "回收商店"},
              {"type_shop", "商店"},
              {"type_admin_shop", "官方商店"},
              {"type_admin_recycle", "官方回收商店"},
              {"type_unknown", "未知类型"},
              {"name_locked", "的上锁箱子"},
              {"name_public", "的公共箱子"},
              {"land_no_permission_container", "§c你没有在此领地使用容器的权限。"},
              {"land_no_permission_place", "§c你没有在此领地放置方块的权限。"},
              {"land_no_permission_destroy", "§c你没有在此领地破坏方块的权限。"},
              {"land_no_permission_pack", "§c你没有在此领地打包箱子的权限。"}}                                         },
            {"shop",
             {{"insufficient_money", "§c你的金币不足！需要 §6{price}§c 金币。"},
              ...
              {"name_too_long", "§c商店名称最多只能包含 {max} 个字符！"},
              {"name_blocked_keyword", "§c商店名称包含被禁止的关键词：{keyword}"},
              {"data_corrupt", "§c该物品数据已损坏，无法购买。"},
              {"item_manage_fail", "§c无法管理该物品，无法从NBT创建物品。"},
              {"item_id_fail", "§c无法管理该物品，无法获取物品ID。"},
              {"chest_empty", "箱子是空的。\n"},
              {"no_records", "§e该商店暂无购买记录。"},
            ...
            {"form",
             {{"shop_items_title", "商品列表"},
              {"shop_items_title_with_owner", "{owner} 的商品列表"},
              ...
              {"input_enchants_example", "§e格式: ID:等级,ID:等级 (如 0:1 表示保护 I)"},
              {"input_enchants_tip", "§e留空则不要求附魔，回收时只要等级不低于要求即可。"},
              {"input_max_recycle", "最大回收数量 (0为无限制)"},
              {"label_item_id_hint", "请输入物品命名空间ID (如 apple 或 diamond_sword)"},
              {"input_item_id", "物品ID"},
              {"label_item_id_tip1", "§e注意: 如果是插件物品，请确保ID正确。"},
              {"label_item_id_tip2", "§e例如: minecraft:apple 或 mypack:custom_item"},
              {"label_setting_price", "正在为物品 {item} 设置价格"},
              {"label_managing_item", "正在管理物品: {item}"},
              {"label_current_price", "当前单价: {price}"},
              {"label_not_priced", "§e未定价"},
              {"label_priced", "§a[已定价: {price}]"},
        ...
        nlohmann::json en = {
            {"chest",
             {{"locked", "§cThis chest is locked, you cannot open it."},
              ...
              {"type_shop", "Shop"},
              {"type_admin_shop", "Admin Shop"},
              {"type_admin_recycle", "Admin Recycle Shop"},
              {"type_unknown", "Unknown Type"},
              {"name_locked", "'s Locked Chest"},
              {"name_public", "'s Public Chest"},
              {"land_no_permission_container", "§cYou don't have permission to use containers in this land."},
              {"land_no_permission_place", "§cYou don't have permission to place blocks in this land."},
              {"land_no_permission_destroy", "§cYou don't have permission to destroy blocks in this land."},
              {"land_no_permission_pack", "§cYou don't have permission to pack chests in this land."}}          },
            {"shop",
             {{"insufficient_money", "§cInsufficient coins! Need §6{price}§c coins."},
              ...
              {"name_too_long", "§cShop name can be at most {max} characters long!"},
              {"name_blocked_keyword", "§cShop name contains a blocked keyword: {keyword}"},
              ...
              {"no_records", "§eNo purchase records for this shop."},
            ...
            {"floating",
             {{"locked", "§e[Locked Chest]§r Owner: {owner}"},
              ...
              {"admin_shop", "§6[Admin Shop]§r"},
              {"admin_recycle", "§6[Admin Recycle Shop]§r"},
            ...
            {"form",
             {{"shop_items_title", "Items List"},
              {"shop_items_title_with_owner", "{owner}'s Items List"},
              ...
              {"input_enchants_example", "§eFormat: ID:Level,ID:Level (e.g. 0:1 for Protection I)"},
              {"input_enchants_tip", "§eLeave empty for no enchant requirement."},
              ...
              {"label_item_id_tip1", "§eNote: Ensure the ID is correct for addon items."},
              {"label_item_id_tip2", "§eExample: minecraft:apple or mypack:custom_item"},
              {"label_setting_price", "Setting price for {item}"},
              {"label_managing_item", "Managing item: {item}"},
              {"label_current_price", "Current Price: {price}"},
              {"label_not_priced", "§eNot Priced"},
              {"label_priced", "§a[Priced: {price}]"},
