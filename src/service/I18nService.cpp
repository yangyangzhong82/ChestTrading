        ...
        nlohmann::json zh = {
            {"chest",
             {{"locked", "§c这个箱子已经被锁定了，你无法打开。"},
              ...
              {"remove_success_refund_self", "§a箱子设置已成功移除！已返还 {price}"},
              {"remove_success_refund_owner", "§a箱子设置已成功移除！已向箱子主人返还 {price}"},
              {"remove_success_refund_fail", "§e箱子设置已成功移除，但返还 {price} 失败。"},
              ...
              {"name_locked", "的上锁箱子"},
              {"name_public", "的公共箱子"},
              {"pack_item_lore", "§7ChestTrading 打包箱子"},
              {"pack_item_type_lore", "§7类型: {type}"},
              ...
              {"create_trade_shop_only_in_pland", "§c当前配置仅允许在 PLand 领地内设置商店和回收商店。"}}                     },
            {"shop",
             {{"insufficient_money", "§c你的金币不足！需要 §6{price}§c 金币。"},
              ...
              {"chest_empty", "箱子是空的，请先将物品放入箱子后再编辑。\n"},
            ...
            {"recycle",
             {{"success", "§a成功回收 {item} x{count}，获得 §6{price}§a 金币。"},
              ...
              {"item_blocked", "§c该物品已被禁止设置回收委托：{item}"},
              {"commission_removed", "§a回收委托已删除！"},
              {"commission_remove_fail", "§c删除回收委托失败！"},
            ...
            {"form",
             {{"shop_items_title", "商品列表"},
              ...
              {"recycle_shop_title_with_owner", "{owner} 的回收商店"},
              ...
              {"chest_ui_item_price", "§6单价: {price}"},
              {"chest_ui_item_stock", "§b库存: {stock}"},
              {"chest_ui_item_hint", "§7点击购买"},
              {"chest_ui_refresh", "§e刷新"},
              {"chest_ui_page_info", "§f第 {page}/{total} 页"},
              {"public_hub_title", "交易大厅"},
              {"public_hub_info", "§7统一入口，打开公开浏览功能"},
              {"public_hub_shops", "§b玩家商店列表"},
              {"public_hub_shops_lore", "§7查看全服公开玩家商店"},
              {"public_hub_items", "§a在售物品列表"},
              {"public_hub_items_lore", "§7查看全服正在出售的物品"},
              {"public_hub_recycle_shops", "§6回收商店列表"},
              {"public_hub_recycle_shops_lore", "§7查看全服公开回收商店"},
              {"public_hub_recycle_items", "§e回收物品列表"},
              {"public_hub_recycle_items_lore", "§7查看全服可回收物品"},
              {"public_hub_ranking", "§d销量榜单"},
              {"public_hub_ranking_lore", "§7查看热门商店销量排行"},
              {"public_hub_records", "§9交易记录"},
              {"public_hub_records_lore", "§7打开交易记录中心"},
              {"public_hub_admin", "§c管理全服箱子"},
              {"public_hub_admin_lore", "§7打开管理员全服箱子管理"},
        ...
        nlohmann::json en = {
            {"chest",
             {{"locked", "§cThis chest is locked, you cannot open it."},
              ...
              {"remove_success_refund_self", "§aChest settings removed successfully! Refunded {price}."},
              {"remove_success_refund_owner", "§aChest settings removed successfully! Refunded {price} to the chest owner."},
              {"remove_success_refund_fail", "§eChest settings removed successfully, but refunding {price} failed."},
              ...
              {"pack_item_lore", "§7ChestTrading Packed Chest"},
              {"pack_item_type_lore", "§7Type: {type}"},
              ...
              {"create_trade_shop_only_in_pland", "§cCurrent config only allows creating shops and recycle shops inside PLand claims."}}          },
            {"shop",
             {{"insufficient_money", "§cInsufficient coins! Need §6{price}§c coins."},
              ...
              {"item_blocked", "§cThis item is blocked from being listed: {item}"},
              ...
              {"chest_empty", "The chest is empty. Put items into the chest before editing.\n"},
            ...
            {"recycle",
             {{"success", "§aSuccessfully recycled {item} x{count}, earned §6{price}§a coins."},
              ...
              {"item_blocked", "§cThis item is blocked from recycle commissions: {item}"},
              {"commission_removed", "§aRecycle commission removed!"},
              {"commission_remove_fail", "§cFailed to remove recycle commission!"},
            ...
            {"floating",
             {{"locked", "§e[Locked Chest]§r Owner: {owner}"},
              ...
              {"shop_sell", "§bSell: {item}§r"},
              {"recycle_buy", "§aRecycle: {item}§r"},
              {"shop_empty", "§7No items§r"},
              {"recycle_empty", "§7No items§r"},
            ...
            {"form",
             {{"shop_items_title", "Items List"},
              ...
              {"chest_manage_admin_content", "Editing {owner}'s {type}"},
              ...
              {"recycle_shop_title_with_owner", "{owner}'s Recycle Shop"},
              ...
              {"recycle_set_price_title", "Set Price"},
              ...
              {"button_pack_chest", "Pack Chest"},
              {"button_edit_commission", "Edit Commission"},
              {"button_remove_commission", "Remove Commission"},
              ...
              {"label_sold_out", "§c[Sold Out]"},
              {"label_db_stock", "DB Stock: {count}"},
              {"label_chest_stock", "Chest Stock: {count}"},
              {"label_buying_item", "Buying item: {item}"},
              {"chest_ui_item_price", "§6Unit Price: {price}"},
              {"chest_ui_item_stock", "§bStock: {stock}"},
              {"chest_ui_item_hint", "§7Click to buy"},
              {"chest_ui_refresh", "§eRefresh"},
              {"chest_ui_page_info", "§fPage {page}/{total}"},
              {"public_hub_title", "Trade Hub"},
              {"public_hub_info", "§7Unified entry for public browsing"},
              {"public_hub_shops", "§bPlayer Shops"},
              {"public_hub_shops_lore", "§7Browse all public player shops"},
              {"public_hub_items", "§aItems For Sale"},
              {"public_hub_items_lore", "§7Browse all publicly listed items"},
              {"public_hub_recycle_shops", "§6Recycle Shops"},
              {"public_hub_recycle_shops_lore", "§7Browse all public recycle shops"},
              {"public_hub_recycle_items", "§eRecycle Items"},
              {"public_hub_recycle_items_lore", "§7Browse all recyclable public items"},
              {"public_hub_ranking", "§dSales Ranking"},
              {"public_hub_ranking_lore", "§7View hot shop sales rankings"},
              {"public_hub_records", "§9Trade Records"},
              {"public_hub_records_lore", "§7Open the trade record center"},
              {"public_hub_admin", "§cManage All Chests"},
              {"public_hub_admin_lore", "§7Open global chest admin management"},
              ...
              {"recycle_remaining_limit", " §e[Remaining: {count}]§r"},
              {"recycle_completed_label", " §7[Completed]§r"},
              {"recycle_require_aux", "\n§eRequired Aux: {value}§r"},
              {"recycle_require_durability", "\n§aMin Durability: {value}§r"},
              {"recycle_require_enchant", "\n§dRequired Enchants: "},
              {"recycle_max_available_label", "Max recyclable now: {count}"},
